...
public enum FeatureSetting {
    ...
    ULTIMATE_ENCHANT_COLOR("enchants.ultimateTier", Feature.ENCHANTMENT_LORE_PARSING),
    ULTIMATE_ENCHANT_BOLD("enchants.bold", Feature.ENCHANTMENT_LORE_PARSING),
    ULTIMATE_ENCHANT_ITALIC("enchants.italic", Feature.ENCHANTMENT_LORE_PARSING),
    ULTIMATE_ENCHANT_UNDERLINED("enchants.underlined", Feature.ENCHANTMENT_LORE_PARSING),
    ULTIMATE_ENCHANT_STRIKETHROUGH("enchants.strikethrough", Feature.ENCHANTMENT_LORE_PARSING),
