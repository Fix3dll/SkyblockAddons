...
public class ColorSelectionGui extends SkyblockAddonsScreen {
     ...
     */
    private void drawHSBPicker(GuiGraphicsExtractor graphics, boolean disabled) {
        ...
        if (!disabled) {
            ...
            graphics.outline(hueX - 2, hueCursorY - 1, hueWidth + 4, 3, ColorCode.WHITE.getColor());
            ...
            graphics.outline(cursorX - 2, cursorY - 2, 4, 4, ColorCode.WHITE.getColor());
        }
    }
