...
public class ColorSelectionGui extends SkyblockAddonsScreen {
    ...
    private void drawHSBPicker(GuiGraphics graphics, boolean disabled) {
        ...
        if (!disabled) {
            ...
            graphics.renderOutline(hueX - 2, hueCursorY - 1, hueWidth + 4, 3, ColorCode.WHITE.getColor());
            ...
            graphics.renderOutline(cursorX - 2, cursorY - 2, 4, 4, ColorCode.WHITE.getColor());
        }
    }
