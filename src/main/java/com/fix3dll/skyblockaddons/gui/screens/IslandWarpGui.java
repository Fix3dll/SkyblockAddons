...
public class IslandWarpGui extends SkyblockAddonsScreen {
    ...
    public enum Marker {
        ...
        HUB("hub", Translations.getMessage("warpMenu.spawn"), Island.HUB, 555, 215),
        ELIZABETH("elizabeth", "Elizabeth", Island.HUB, 495, 185),
        CASTLE("castle", "Castle", Island.HUB, 155, 70),
        DARK_AUCTION("da", "Sirius Shack", Island.HUB, 450, 440),
        CRYPT("crypt", "Crypts", Island.HUB, 505, 75),
        WIZARD_TOWER("wizard", "Wizard Tower", Island.HUB, 500, 310),
        MUSEUM("museum", "Museum", Island.HUB, 620, 275),
        TRADE_CENTER("stonks", "Trade Center", Island.HUB, 640, 160),
        CARNIVAL("carnival", "Carnival", Island.HUB, 440, 160),

        SPIDERS_DEN("spider", Translations.getMessage("warpMenu.spawn"), Island.SPIDERS_DEN, 290, 250),
        SPIDERS_DEN_NEST("nest", "Top of Nest", Island.SPIDERS_DEN, 395, 60),
        ...
        VOID_SEPULTURE("void", "Void Sepulture", Island.THE_END, 370, 190),
        ...
        THE_BARN("barn", Translations.getMessage("warpMenu.spawn"), Island.THE_BARN, 200, 230),
        MUSHROOM_DESERT("desert", Translations.getMessage("warpMenu.spawn"), Island.MUSHROOM_DESERT, 250, 320),
        TRAPPER("trapper", "Trapper's Hut", Island.MUSHROOM_DESERT, 190, 85),
