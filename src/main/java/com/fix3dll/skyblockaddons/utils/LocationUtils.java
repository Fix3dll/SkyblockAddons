...
public class LocationUtils {
     ...
     */
    private static final Set<String> zealotSpawnLocations = Set.of(
            "Dragon's Nest", "Zealot Bruiser Hideout"
    );

    /**
     * List of locations that counts in Glacite Tunnels
     */
    private static final Set<String> glaciteTunnelsLocations = Set.of(
            "Dwarven Base Camp", "Fossil Research Center", "Glacite Tunnels", "Great Glacite Lake"
    );
