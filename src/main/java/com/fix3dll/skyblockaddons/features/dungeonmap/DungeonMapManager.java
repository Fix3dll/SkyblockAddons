...
public class DungeonMapManager {
    ...
    private static final ResourceLocation DUNGEON_MAP = ResourceLocation.fromNamespaceAndPath(SkyblockAddons.MOD_ID, "dungeonsmap.png");
...
//    @Getter
//    private static double markerOffsetX = 0;
...
//    static {
//        try {
//            lastReportedPosX = ReflectionHelper.findField(LocalPlayer.class, "bK", "field_175172_bI",
//                    "lastReportedPosX");
...
//
    ...
    private static float transformXY(float xy, int widthHeight, float scale) {
        double minecraftScale = Minecraft.getInstance().getWindow().getGuiScale();
