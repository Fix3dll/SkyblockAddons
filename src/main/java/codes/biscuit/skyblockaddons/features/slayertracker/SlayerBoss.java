...
public enum SlayerBoss {
    ...
    RIFTSTALKER("Vampire", COVEN_SEAL, QUANTUM_BOOK_BUNDLE, SOULTWIST_RUNE, BUBBA_BLISTER, FANGTASTIC_CHOCOLATE_CHIP, GUARDIAN_LUCKY_BLOCK, MCGRUBBER_BURGER, UNFANGED_VAMPIRE_PART,THE_ONE_BOOK_BUNDLE);
