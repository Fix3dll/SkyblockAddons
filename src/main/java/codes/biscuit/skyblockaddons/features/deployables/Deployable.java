...
public enum Deployable {
    // Orbs
    RADIANT("§aRadiant", 0.01, 0.0, 0, 0, 0.0, 18*18, "radiant"),
    MANA_FLUX("§9Mana Flux", 0.02, 0.5, 10, 0, 0.0, 18*18, "manaflux"),
    OVERFLUX("§5Overflux", 0.025, 1, 25, 5, 5.0, 18*18, "overflux"),
    PLASMAFLUX("§d§lPlasmaflux", 0.03, 1.25, 35, 7.5, 7.5, 20*20, "plasmaflux"),
