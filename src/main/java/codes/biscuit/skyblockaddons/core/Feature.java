...
public enum Feature {
    ...
    HIDE_WHEN_NOT_IN_RIFT(232, null, false),
    ...
    private static final Set<Feature> SETTINGS = Sets.newHashSet(DOUBLE_DROP_IN_OTHER_GAMES,
            ...
            RESET_SALVAGED_ESSENCES_AFTER_LEAVING_MENU, RIFTSTALKER_COLOR_BY_RARITY, RIFTSTALKER_TEXT_MODE, HIDE_WHEN_NOT_IN_RIFT);
    ...
    private static final Set<Feature> guiFeatures = new LinkedHashSet<>(Arrays.asList(DRILL_FUEL_BAR, SKILL_PROGRESS_BAR, MANA_BAR, HEALTH_BAR,
            ...
            CRIMSON_ARMOR_ABILITY_STACKS, HIDE_TRUE_DEFENSE, RIFTSTALKER_SLAYER_TRACKER));
