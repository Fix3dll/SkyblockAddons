...
public enum Feature {
    ...
    DRAGON_STATS_TRACKER(125, "settings.dragonStatsTracker", new GuiFeatureData(EnumUtils.DrawType.DRAGON_STATS_TRACKER, ColorCode.WHITE), false, EnumUtils.FeatureSetting.COLOUR_BY_RARITY, EnumUtils.FeatureSetting.DRAGONS_NEST_ONLY),
